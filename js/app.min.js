...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var _modules_page_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/page.js */ \"./src/js/modules/page.js\");\n/* harmony import */ var _modules_form_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/form.js */ \"./src/js/modules/form.js\");\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.esm.js\");\n/* harmony import */ var simpleBar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! simpleBar */ \"./node_modules/simpleBar/dist/simplebar.esm.js\");\n/* harmony import */ var cropperjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! cropperjs */ \"./node_modules/cropperjs/dist/cropper.js\");\n//-------- Functions -----------\r\n\r\n//functions.isWebp();\r\n//functions.screenType();\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.menuBurger();\r\n//functions.moveElement();\r\n//functions.videoPlayer();\r\n//functions.diagram();\r\n\r\n\r\n//-------- Animation -----------\r\n//import * as animation from \"./modules/animation.js\";\r\n//animation.scrollAnimation();\r\n//animation.headerChange(400);\r\n//animation.typeText(50);\r\n//animation.counter();\r\n\r\n\r\n//-------- Page elements -----------\r\n\r\nwindow.onload = function () {\r\n    _modules_page_js__WEBPACK_IMPORTED_MODULE_1__.spollers();\r\n    //page.tabs('.tabs');\r\n    _modules_page_js__WEBPACK_IMPORTED_MODULE_1__.tabs(1);\r\n    _modules_page_js__WEBPACK_IMPORTED_MODULE_1__.tabs(2);\r\n    _modules_page_js__WEBPACK_IMPORTED_MODULE_1__.tabs(3);\r\n    _modules_page_js__WEBPACK_IMPORTED_MODULE_1__.popup();\r\n}\r\n\r\n//-------- Form elements -----------\r\n;\r\n_modules_form_js__WEBPACK_IMPORTED_MODULE_2__.checkbox();\r\n_modules_form_js__WEBPACK_IMPORTED_MODULE_2__.radio();\r\n_modules_form_js__WEBPACK_IMPORTED_MODULE_2__.select();\r\n\r\n\r\n//-------- Ratings -----------\r\n//import * as rating from \"./modules/rating.js\";\r\n//rating.star();\r\n\r\n\r\n//-------- Cart -----------\r\n//import * as cart from \"./modules/cart.js\";\r\n//cart.count();\r\n\r\n\r\n//function emailTest(input) {\r\n//    return !/^\\w+([\\.-]?\\w+)*@\\w+([\\.-]?\\w+)*(\\.\\w{2,8})+$/.test(input.value);\r\n//}\r\n\r\nconst searchBtn = document.querySelector('.header__search-btn');\r\nconst searchForm = document.querySelector('.search-header');\r\n\r\nif (searchBtn) {\r\n    searchBtn.addEventListener('click', () => {\r\n        searchForm.classList.toggle('active');\r\n    });\r\n}\r\n\r\nconst authorFriends = document.querySelectorAll('.author__friends');\r\nif (authorFriends.length > 0) {\r\n    authorFriends.forEach((el) => {\r\n        el.addEventListener('click', (e) => {\r\n            e.stopPropagation();\r\n        });\r\n    });\r\n}\r\n\r\nconst switchers = document.querySelectorAll('.switcher');\r\nif (switchers.length > 0) {\r\n    switchers.forEach((switcher) => {\r\n        switcher.addEventListener('click', () => {\r\n            switcher.classList.toggle('active');\r\n        });\r\n    });\r\n}\r\n\r\nconst optionBtns = document.querySelectorAll('.options__icon');\r\nconst options = document.querySelectorAll('.options');\r\nif (optionBtns.length > 0) {\r\n    optionBtns.forEach((optionBtn) => {\r\n        optionBtn.addEventListener('click', () => {\r\n            if (!optionBtn.closest('.options').classList.contains('active')) {\r\n                options.forEach((option) => {\r\n                    option.classList.remove('active');\r\n                });\r\n                messages.forEach((message) => {\r\n                    message.classList.remove('active');\r\n                });\r\n            }\r\n            optionBtn.closest('.options').classList.toggle('active');\r\n        });\r\n    });\r\n}\r\n\r\nconst optionsLinks = document.querySelectorAll('.options__link');\r\nif (optionsLinks.length > 0) {\r\n    optionsLinks.forEach((optionsLink) => {\r\n        optionsLink.addEventListener('click', () => {\r\n            optionsLink.closest('.options').classList.remove('active');\r\n        });\r\n    });\r\n}\r\n\r\nconst messageBtns = document.querySelectorAll('.messages__icon');\r\nconst messages = document.querySelectorAll('.messages__body');\r\nif (messageBtns.length > 0) {\r\n    messageBtns.forEach((messageBtn) => {\r\n        messageBtn.addEventListener('click', () => {\r\n            if (!messageBtn.nextElementSibling.classList.contains('active')) {\r\n                messages.forEach((message) => {\r\n                    message.classList.remove('active');\r\n                });\r\n                options.forEach((option) => {\r\n                    option.classList.remove('active');\r\n                });\r\n            }\r\n            messageBtn.nextElementSibling.classList.toggle('active');\r\n        });\r\n    });\r\n}\r\n\r\nconst messageCloseBtns = document.querySelectorAll('.messages__close');\r\nif (messageCloseBtns.length > 0) {\r\n    messageCloseBtns.forEach((messageCloseBtn) => {\r\n        messageCloseBtn.addEventListener('click', () => {\r\n            messageCloseBtn.closest('.messages__body').classList.remove('active');\r\n        });\r\n    });\r\n}\r\n\r\nfunction searchResult(input) {\r\n    const searchInput = document.querySelector(input);\r\n    if (searchInput) {\r\n        searchInput.addEventListener('keypress', () => {\r\n            if (!searchInput.nextElementSibling.classList.add('active')) {\r\n                messages.forEach((message) => {\r\n                    message.classList.remove('active');\r\n                });\r\n                options.forEach((option) => {\r\n                    option.classList.remove('active');\r\n                });\r\n            }\r\n            searchInput.nextElementSibling.classList.add('active');\r\n        });\r\n    }\r\n}\r\n\r\nfunction emojiShow(emoji, list) {\r\n    const emojiPostBtns = document.querySelectorAll(emoji);\r\n    if (emojiPostBtns.length > 0) {\r\n        emojiPostBtns.forEach((emojiPostBtn) => {\r\n            emojiPostBtn.addEventListener('mouseover', () => {\r\n                emojiPostBtn.querySelector(list).classList.add('active');\r\n            });\r\n            emojiPostBtn.addEventListener('mouseout', () => {\r\n                emojiPostBtn.querySelector(list).classList.remove('active');\r\n            });\r\n        });\r\n    }\r\n}\r\n\r\nfunction emojiPicker(smiles, message) {\r\n    const emojis = document.querySelectorAll(smiles);\r\n    if (emojis.length > 0) {\r\n        emojis.forEach((emoji) => {\r\n            emoji.addEventListener('click', () => {\r\n                document.querySelector(message).value += emoji.innerHTML;\r\n            });\r\n        });\r\n    }\r\n}\r\n\r\nfunction userPicker(user, message) {\r\n    const messegesUsers = document.querySelectorAll(user);\r\n    if (messegesUsers.length > 0) {\r\n        messegesUsers.forEach((messegesUser) => {\r\n            messegesUser.addEventListener('click', () => {\r\n                document.querySelector(message).value += messegesUser.innerHTML;\r\n                messegesUser.closest('.messages__body').classList.remove('active');\r\n            });\r\n        });\r\n    }\r\n}\r\nuserPicker('.messages__user', '.comments__form input');\r\nsearchResult('.search-header__input');\r\nsearchResult('.comments__form input');\r\nemojiShow('.emoji-post', '.emoji-post__list');\r\nemojiShow('.emoji-minichat', '.emoji-minichat__list');\r\nemojiPicker('.emoji__item', '.comments__input');\r\nemojiPicker('.emoji-post__item', '.post-new__message');\r\nemojiPicker('.emoji-minichat__item', '.minichat__input');\r\n\r\nconst navPages = document.querySelectorAll('.navigation__page');\r\nif (navPages.length > 0) {\r\n    for (let index = 0; index < navPages.length; index++) {\r\n        const navPage = navPages[index];\r\n        navPage.addEventListener('click', () => {\r\n            if (!navPage.classList.contains('active')) {\r\n                navPages.forEach((el) => {\r\n                    el.classList.remove('active');\r\n                });\r\n                navPage.classList.add('active');\r\n            }\r\n        });\r\n    }\r\n}\r\n\r\nconst showAllBtns = document.querySelectorAll('.show-all');\r\nif (showAllBtns.length > 0) {\r\n    for (let index = 0; index < showAllBtns.length; index++) {\r\n        const showAllBtn = showAllBtns[index];\r\n        showAllBtn.addEventListener('click', () => {\r\n\r\n            const hiddenElems = showAllBtn.closest('.tabs__block').querySelectorAll('.hidden');\r\n            hiddenElems.forEach((el) => {\r\n                el.classList.remove('hidden');\r\n            });\r\n            showAllBtn.classList.add('hidden');\r\n\r\n            const tabBlocks = showAllBtn.closest('.tabs__block');\r\n            const tabsBody = tabBlocks.closest('.tabs__body');\r\n\r\n            tabsBody.style.height = tabBlocks.offsetHeight + \"px\";\r\n\r\n            const parentBlock = tabsBody.parentNode.closest('.tabs__block');\r\n            if (parentBlock) {\r\n                const parentBody = parentBlock.closest('.tabs__body');\r\n                //setTimeout(() => {\r\n                parentBody.style.height = parentBlock.offsetHeight + \"px\";\r\n                //}, 400);\r\n            }\r\n        });\r\n    }\r\n}\r\n\r\n\r\n\r\nconst photoViewer = new swiper__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('.photo-viewer__slider', {\r\n    modules: [swiper__WEBPACK_IMPORTED_MODULE_3__.Controller, swiper__WEBPACK_IMPORTED_MODULE_3__.Navigation],\r\n    speed: 400,\r\n    navigation: {\r\n        nextEl: '.photo-viewer__next',\r\n        prevEl: '.photo-viewer__prev',\r\n    },\r\n    observer: true,\r\n    observeParents: true,\r\n    observeSlideChildren: true,\r\n});\r\n\r\nconst commentsViewer = new swiper__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('.comments-viewer__slider', {\r\n    modules: [swiper__WEBPACK_IMPORTED_MODULE_3__.EffectFade],\r\n    speed: 400,\r\n    simulateTouch: false,\r\n    effect: \"fade\",\r\n    //spaceBetween: 100,\r\n});\r\n\r\nphotoViewer.controller.control = commentsViewer;\r\n\r\nlet currentSlide;\r\n\r\nconst galleryItems = document.querySelectorAll('.gallery__item');\r\n\r\nif (galleryItems.length > 0) {\r\n    for (let index = 0; index < galleryItems.length; index++) {\r\n        const galleryItem = galleryItems[index];\r\n        const galleryLink = galleryItem.querySelector('.gallery__link');\r\n\r\n        const photoWrapper = document.querySelector('.photo-viewer__wrapper');\r\n        const commentsWrapper = document.querySelector('.comments-viewer__wrapper');\r\n\r\n        const photoSlide = galleryLink.querySelector('.photo-viewer__slide').cloneNode(true);\r\n        const commentSlide = galleryLink.querySelector('.comments-viewer__slide').cloneNode(true);\r\n\r\n        photoWrapper.append(photoSlide);\r\n        commentsWrapper.append(commentSlide);\r\n\r\n        galleryLink.addEventListener('click', () => {\r\n            document.querySelector(`${galleryLink.dataset.target}`).classList.add('open');\r\n            currentSlide = index;\r\n            photoViewer.slideTo(currentSlide);\r\n        });\r\n    }\r\n}\r\n\r\nconst ratingSortBtns = document.querySelectorAll('.header-rating__btn');\r\nif (ratingSortBtns.length > 0) {\r\n    for (let index = 0; index < ratingSortBtns.length; index++) {\r\n        const ratingSortBtn = ratingSortBtns[index];\r\n\r\n        ratingSortBtn.addEventListener('click', () => {\r\n            if (!ratingSortBtn.classList.contains('active')) {\r\n                ratingSortBtns.forEach((el) => {\r\n                    el.classList.remove('active');\r\n                });\r\n                ratingSortBtn.classList.add('active');\r\n            }\r\n        });\r\n    }\r\n}\r\n\r\nconst moreBtns = document.querySelectorAll('.content__more');\r\nif (moreBtns.length > 0) {\r\n    for (let index = 0; index < moreBtns.length; index++) {\r\n        const moreBtn = moreBtns[index];\r\n        const hiddenElems = document.querySelectorAll('.hidden');\r\n\r\n        moreBtn.addEventListener('click', () => {\r\n            if (hiddenElems.length > 0) {\r\n                hiddenElems.forEach((el) => {\r\n                    el.classList.remove('hidden');\r\n                });\r\n            }\r\n        });\r\n    }\r\n}\r\n\r\nconst checkAllBtns = document.querySelectorAll('.sidebar-chat__check');\r\nif (checkAllBtns.length > 0) {\r\n    for (let index = 0; index < checkAllBtns.length; index++) {\r\n        const checkAllBtn = checkAllBtns[index];\r\n        const circleClosest = checkAllBtn.closest('.sidebar-chat__item');\r\n        const circleItems = circleClosest.querySelectorAll('.sidebar-chat__name');\r\n\r\n        checkAllBtn.addEventListener('click', () => {\r\n            if (checkAllBtn.classList.contains('active')) {\r\n                circleItems.forEach((el) => {\r\n                    el.classList.add('active');\r\n                });\r\n            } else {\r\n                circleItems.forEach((el) => {\r\n                    el.classList.remove('active');\r\n                });\r\n            }\r\n        });\r\n    }\r\n}\r\n\r\nconst visibilityBlocks = document.querySelectorAll('.visibility');\r\nif (visibilityBlocks.length > 0) {\r\n    for (let index = 0; index < visibilityBlocks.length; index++) {\r\n        const visibilityBlock = visibilityBlocks[index];\r\n        const options = visibilityBlock.querySelectorAll('.radio-options__item');\r\n\r\n        visibilityBlock.addEventListener('click', () => {\r\n            visibilityBlock.querySelector('.visibility__list').classList.toggle('active');\r\n        });\r\n\r\n        options.forEach((option) => {\r\n            option.addEventListener('click', () => {\r\n                visibilityBlock.children[0].innerHTML = option.querySelector('span').innerHTML;\r\n                visibilityBlock.children[1].innerHTML = option.querySelector('svg').innerHTML;\r\n            });\r\n        });\r\n    }\r\n}\r\n\r\nconst pointsCount = document.querySelector('.popup-confirm__form input');\r\nif (pointsCount) {\r\n    pointsCount.addEventListener('change', () => {\r\n        document.querySelector('.popup-confirm__result span').innerHTML = pointsCount.value * 50;\r\n    });\r\n}\r\n\r\nconst messageEditBtns = document.querySelectorAll('.body-chat__edit');\r\nif (messageEditBtns.length > 0) {\r\n    for (let index = 0; index < messageEditBtns.length; index++) {\r\n        const messageEditBtn = messageEditBtns[index];\r\n        const messageTextArea = messageEditBtn.closest('.body-chat__item').querySelector('.body-chat__text');\r\n\r\n        messageEditBtn.addEventListener('click', (e) => {\r\n            messageEditBtn.closest('.body-chat__item').classList.add('active');\r\n            if (messageTextArea) {\r\n                messageTextArea.disabled = true;\r\n                messageTextArea.blur();\r\n            }\r\n            e.preventDefault();\r\n        });\r\n\r\n        if (messageTextArea) {\r\n            messageTextArea.addEventListener('input', () => {\r\n                messageTextArea.style.height = messageTextArea.scrollHeight + 'px';\r\n            });\r\n        }\r\n    }\r\n}\r\n\r\nconst messageDeleteBtns = document.querySelectorAll('.body-chat__delete');\r\nif (messageDeleteBtns.length > 0) {\r\n    for (let index = 0; index < messageDeleteBtns.length; index++) {\r\n        const messageDeleteBtn = messageDeleteBtns[index];\r\n\r\n        messageDeleteBtn.addEventListener('click', () => {\r\n            messageDeleteBtn.closest('.body-chat__item').remove();\r\n        });\r\n    }\r\n}\r\n\r\nconst messageSaveBtns = document.querySelectorAll('.body-chat__save');\r\nif (messageSaveBtns.length > 0) {\r\n    for (let index = 0; index < messageSaveBtns.length; index++) {\r\n        const messageSaveBtn = messageSaveBtns[index];\r\n        const messageTextArea = messageSaveBtn.closest('.body-chat__item').querySelector('.body-chat__text');\r\n\r\n        messageSaveBtn.addEventListener('click', (e) => {\r\n            messageSaveBtn.closest('.body-chat__item').classList.remove('active');\r\n            if (messageTextArea) {\r\n                messageTextArea.disabled = true;\r\n                messageTextArea.blur();\r\n            }\r\n            e.preventDefault();\r\n        });\r\n    }\r\n}\r\n\r\nconst messageDiscardeBtns = document.querySelectorAll('.body-chat__discard');\r\nif (messageDiscardeBtns.length > 0) {\r\n    for (let index = 0; index < messageDiscardeBtns.length; index++) {\r\n        const messageDiscardeBtn = messageDiscardeBtns[index];\r\n        const messageTextArea = messageDiscardeBtn.closest('.body-chat__item').querySelector('.body-chat__text');\r\n\r\n        messageDiscardeBtn.addEventListener('click', (e) => {\r\n            messageDiscardeBtn.closest('.body-chat__item').classList.remove('active');\r\n            if (messageTextArea) {\r\n                messageTextArea.disabled = true;\r\n                messageTextArea.blur();\r\n            }\r\n            e.preventDefault();\r\n        });\r\n    }\r\n}\r\n\r\nconst linkCopy = document.querySelector('.header__btn');\r\nif (linkCopy) {\r\n    linkCopy.addEventListener('click', (e) => {\r\n        linkCopy.classList.add('active');\r\n        e.preventDefault();\r\n    });\r\n}\r\n\r\nconst passwordShowBtns = document.querySelectorAll('.settings__hide');\r\nif (passwordShowBtns.length > 0) {\r\n    for (let index = 0; index < passwordShowBtns.length; index++) {\r\n        const passwordShowBtn = passwordShowBtns[index];\r\n\r\n        passwordShowBtn.addEventListener('click', () => {\r\n            if (!passwordShowBtn.classList.contains('active')) {\r\n                passwordShowBtn.previousElementSibling.type = 'text';\r\n            } else {\r\n                passwordShowBtn.previousElementSibling.type = 'password';\r\n            }\r\n            passwordShowBtn.classList.toggle('active');\r\n        });\r\n    }\r\n}\r\n\r\nconst settingsSelectItems = document.querySelectorAll('.select-settings');\r\nif (settingsSelectItems.length > 0) {\r\n    for (let index = 0; index < settingsSelectItems.length; index++) {\r\n        const settingsSelectItem = settingsSelectItems[index];\r\n        const options = settingsSelectItem.querySelectorAll('.radio-options__item');\r\n\r\n        settingsSelectItem.addEventListener('click', () => {\r\n            settingsSelectItem.querySelector('.select-settings__list').classList.toggle('active');\r\n        });\r\n\r\n        options.forEach((option) => {\r\n            option.addEventListener('click', () => {\r\n                settingsSelectItem.children[0].innerHTML = option.querySelector('span').innerHTML;\r\n            });\r\n        });\r\n    }\r\n}\r\n\r\nconst mainForms = document.querySelectorAll('.registration');\r\nconst regBtn = document.querySelector('.header__btn_registration');\r\nif (regBtn) {\r\n    regBtn.addEventListener('click', (e) => {\r\n        mainForms.forEach((mainForm) => {\r\n            mainForm.classList.remove('active');\r\n        });\r\n        document.querySelector('#registration').classList.add('active');\r\n        e.preventDefault();\r\n    });\r\n}\r\n\r\nconst authBtn = document.querySelector('.header__btn_authorisation');\r\nif (authBtn) {\r\n    authBtn.addEventListener('click', (e) => {\r\n        mainForms.forEach((mainForm) => {\r\n            mainForm.classList.remove('active');\r\n        });\r\n        document.querySelector('#authorisation').classList.add('active');\r\n        e.preventDefault();\r\n    });\r\n}\r\n\r\nconst offerAuthBtn = document.querySelector('.offer__btn_auth');\r\nif (offerAuthBtn) {\r\n    offerAuthBtn.addEventListener('click', (e) => {\r\n        mainForms.forEach((mainForm) => {\r\n            mainForm.classList.remove('active');\r\n        });\r\n        document.querySelector('#authorisation').classList.add('active');\r\n        e.preventDefault();\r\n    });\r\n}\r\n\r\nconst authRegBtn = document.querySelector('.registration__reg');\r\nif (authRegBtn) {\r\n    authRegBtn.addEventListener('click', (e) => {\r\n        mainForms.forEach((mainForm) => {\r\n            mainForm.classList.remove('active');\r\n        });\r\n        document.querySelector('#registration').classList.add('active');\r\n        e.preventDefault();\r\n    });\r\n}\r\n\r\nconst forgotBtn = document.querySelector('.registration__forgot');\r\nif (forgotBtn) {\r\n    forgotBtn.addEventListener('click', (e) => {\r\n        mainForms.forEach((mainForm) => {\r\n            mainForm.classList.remove('active');\r\n        });\r\n        document.querySelector('#recover').classList.add('active');\r\n        e.preventDefault();\r\n    });\r\n}\r\n\r\nconst restoreBtn = document.querySelector('.registration__restore');\r\nif (restoreBtn) {\r\n    restoreBtn.addEventListener('click', (e) => {\r\n        mainForms.forEach((mainForm) => {\r\n            mainForm.classList.remove('active');\r\n        });\r\n        document.querySelector('#restore').classList.add('active');\r\n        e.preventDefault();\r\n    });\r\n}\r\n\r\nconst resetPassword = document.querySelector('.registration__reset');\r\nif (resetPassword) {\r\n    resetPassword.addEventListener('click', (e) => {\r\n        resetPassword.closest('.form-registration').querySelector('.form-registration__error').classList.add('active');\r\n        e.preventDefault();\r\n    });\r\n}\r\n\r\nconst minichat = document.querySelector('.minichat');\r\nif (minichat) {\r\n    const minichatShow = minichat.querySelector('.minichat__btn');\r\n    const minichatClose = minichat.querySelector('.minichat__close');\r\n\r\n    minichatShow.addEventListener('click', () => {\r\n        minichatShow.classList.add('hidden');\r\n        minichat.classList.add('active');\r\n    });\r\n\r\n    minichatClose.addEventListener('click', () => {\r\n        minichatShow.classList.remove('hidden');\r\n        minichat.classList.remove('active');\r\n    });\r\n}\r\n\r\n// const minichatGalleries = document.querySelectorAll('.minichat__gallery');\r\n// if (minichatGalleries.length > 0) {\r\n//     for (let index = 0; index < minichatGalleries.length; index++) {\r\n//         const minichatGallery = minichatGalleries[index];\r\n//         const photos = minichatGallery.querySelectorAll('.minichat__photo');\r\n//         minichatGallery.classList.add(`minichat__gallery_${photos.length}`);\r\n//     }\r\n// }\r\n\r\n\r\nfunction pressEsc() {\r\n    document.addEventListener('keydown', (e) => {\r\n        if (e.key === 'Escape') {\r\n            document.querySelectorAll('.options').forEach((el) => {\r\n                el.classList.remove('active');\r\n            });\r\n            document.querySelectorAll('.messages__body').forEach((el) => {\r\n                el.classList.remove('active');\r\n            });\r\n            document.querySelectorAll('.visibility__list').forEach((el) => {\r\n                el.classList.remove('active');\r\n            });\r\n            document.querySelectorAll('.popup').forEach((el) => {\r\n                el.classList.remove('open');\r\n            });\r\n            document.querySelectorAll('.registration').forEach((el) => {\r\n                el.classList.remove('active');\r\n            });\r\n        }\r\n    });\r\n}\r\npressEsc();\r\n\r\n\r\n\r\n\r\n\r\n\r\nconst image = document.querySelector('.popup-confirm__crop img');\r\nconst cropper = new cropperjs__WEBPACK_IMPORTED_MODULE_5__(image, {\r\n    zoomable: false,\r\n    minCropBoxWidth: 600,\r\n    autoCropArea: 0.5,\r\n});\n\n//# sourceURL=webpack:///./src/js/app.js?");
